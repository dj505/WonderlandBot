...
class FriendCode:
    ...
    async def fcregister(self, ctx, fc):
        ...
        for row in rows:
            ...
            await self.bot.say("Please delete your current friend code with `k!fcdelete` before adding another.")
            return
    ...
    async def fcquery(self, ctx, user):
        ...
        for row in rows:
            ...
            return
        await self.bot.say("You need to register your own friend code with `k!fcregister <friendcode>` before getting others.")
